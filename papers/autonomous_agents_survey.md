...
**Lianhao Zhou**[1] **Hongyi Ling**[1] **Cong Fu**[1] **Yepeng Huang**[2] **Michael Sun**[3] **Wendi Yu**[1] **Xiaoxuan Wang**[4] **Xiner Li**[1] **Xingyu Su**[1] **Junkai Zhang**[4] **Xiusi Chen**[5] **Chenxing Liang**[1] **Xiaofeng Qian**[6] _[,]_[ 7] _[,]_[ 8] **Heng Ji**[5] **Wei Wang**[4] **Marinka Zitnik**[2] **Shuiwang Ji**[1] _[,]_[ 6] _[,]_[ 9] _[∗]_ 
...
8Department of Physics and Astronomy, Texas A&M University 
...
Phase 1: Hypothesis Discovery<br>Human Proposes Goal / ProblemHigh-Level  Knowledge Extraction Hypothesis Generation Screening & Hypothesis Validation<br>Experimental<br>Design<br>Phase 2: Experimental Design & Execution<br>Existing Tool Library Tool Use :<br>(Simulators,  AI generates code to  No<br>Databases,Robots) call existing tools<br>Detailed<br>New Scientific Tool  AI generates code for Tool Creation : Yes New Tool Needed? Workflow<br>/Algorithm new algorithms/tools<br>Experimental<br>Data Phase 3: Result Analysis & Refinement<br>Automatic Self-Correction<br>Refinement  External Evaluation &Feedback<br>Results  Loop Validated<br>Analysis Human-in-the-Loop Findings<br>**----- End of picture text -----**<br>
...
**==> picture [377 x 466] intentionally omitted <==**

**----- Start of picture text -----**<br>
e.g., BioBERT [Lee et al., 2020], BioGPT [Luo et al., 2022], Galactica [Tay-<br>Scientific Foundation Mod- lor et al., 2022], ether0 [Narayanan et al., 2025],ChemDFM [Zhao et al.,<br>els<br>2025],LPMs [Barman et al., 2025]<br>KnowledgeExtraction RAG-based e.g., et al.,CLADD2025a],CLEAR[Lee et al.,[Lopez2025],et al.,CASSIA2025] [Xie et al., 2024],FRAG [Gao<br>e.g., ChemMiner [Chen et al., 2024a], ChartAssistant [Meng et al.,<br>Multimodal Knowledge 2024], GPT-4o [Hurst et al., 2024],MatViX [Khalighinejad et al.,<br>Extraction<br>2024],nanoMINER Odobesku et al. [2025]<br>Prompt-Based e.g., Biomedicine [Qi et al., 2023], General Science [Xiong et al., 2025]<br>Knowledge-Grounded e.g., KG-CoI [Xiong et al., 2024], ResearchLink [Borrego et al., 2025]<br>GenerationHypothesis Multi-Agent e.g., 2025a],AI VIRSCIco-scientist[Su[Gottweiset al., 2024],et al.,AstroAgents2025a], ACCELMAT[Saeedi et al.,[Kumbhar2025] et al.,<br>Evolutionary Algorithm- e.g., MOOSE-Chem [Yang et al., 2025], HypoAgents [Duan et al., 2025],<br>Based MolLEO [Wang et al., 2024b]<br>e.g., POPPER [Huang et al., 2025a], SCIMON [Wang et al., 2024c], MAT-<br>Metric-Based Screening DESIGN [Kumbhar et al., 2025b], HypoBench [Liu et al., 2025a], Logit-<br>Hypothesis based Calibrated Prior [Gong and Fernandez, 2025]<br>Screening<br>& Validation Agent-Based Validation (SGA) e.g., ResearchAgent[Ma et al., 2024][Baek et al., 2024], Scientific Generative Agent<br>Experimental Design & Execution<br>RAG-based Planning X e.g., [ChenBiomniet al.,[Huang2023a],et CLADDal., 2025b],[LeeTxAgentet al., 2025][Gao et al., 2025b], Chemist-<br>Human High-Level Guid- e.g., CRISPR-GPT [Qu et al., 2025], AI co-scientist [Gottweis et al., 2025a],<br>ance Virtual Lab [Swanson et al., 2024]<br>Experimental<br>Design Templates & Predefined e.g., k-agents [Cao et al., 2024], CRISPR-GPT [Qu et al., 2025], PerTurboA-<br>Actions gent [Hao et al., 2025]<br>e.g., ChemToolAgent [Yu et al., 2024a], BioInformatics Agent [Xin et al.,<br>Post-Execution Feedback 2024], BioDiscoveryAgent [Roohani et al., 2024], OSDA Agent [Hu et al.,<br>2025]<br>e.g., OSDA Agent [Hu et al., 2025], LLMatDesign [Jia et al., 2024],<br>Embedded MatLLMSearch [Gan et al., 2025], scBaseCount [Youngblut et al., 2025],<br>Chemist-X [Chen et al., 2023a]<br>e.g., AgentMD [Jin et al., 2024a], ChemCrow [M. Bran et al., 2024], scA-<br>Toolbox-Based gent [Mao et al., 2025], TxAgent [Gao et al., 2025b], GIS Copilot [Akin-<br>boyewa et al., 2025], SciToolAgent [Chen et al., 2025a]<br>Tool Use e.g., ChemToolAgent [Yu et al., 2024b], Biomni [Huang et al., 2025b], Per-<br>Reflective & Iterative TurboAgent [Hao et al., 2025]<br>e.g., TAIS [Liu et al., 2024a], MedAgents [Tang et al., 2023], ChemA-<br>gents [Song et al., 2025], AtomAgent [Ghafarollahi and Buehler, 2024b],<br>Hierarchical in MAS ProtAgents [Ghafarollahi and Buehler, 2024a], ChatGPT Research<br>Group [Zheng et al., 2023], Virtual Lab [Swanson et al., 2024], k-<br>agents [Cao et al., 2024]<br>e.g., ToolUniverse [Gao et al., 2025c], MAPPS [Zhou et al., 2025a], CodePDE [Li et al., 2025a], AlphaE-<br>Tool Creation volve [Novikov et al., 2025], TOOLMAKER [Wölflein et al., 2025], ShinkaEvolve Lange et al. [2025]<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
Modality-Driven e.g., ChartLlamaThe AI[HanScientist-v2et al., 2023],[YamadaChartAssisstantet al., 2025],[MengPlotGenet al.,[Luo2024]et al., 2024],<br>Result Analysis Tool-Augmented e.g., Lab [BoeckChemCrowet al.,[Bran2023]et al., 2023], Coscientist [Boiko et al., 2023], Virtual<br>e.g., Data Interpreter [Hong et al., 2024], LLM-SR [Kamienny et al., 2024],<br>Computation-Native MOBLLM [Binbas et al., 2024]<br>e.g., Self-Refine [Madaan et al., 2023], ChemAgent [Tang et al., 2025], Spa-<br>Automatic Self-correction tialAgent [Wang et al., 2025a], TAIS [Liu et al., 2024a], BioInformatics<br>Agent [Xin et al., 2024]<br>Iterative<br>e.g., CRITIC [Gou et al., 2023], OSDA Agent [Hu et al., 2025], AI co-<br>Validation External Evaluation & scientist [Gottweis et al., 2025a], BioDiscoveryAgent [Roohani et al., 2024],<br>& Refinement Feedback SAMPLE [Rapp et al., 2024], Biomni [Huang et al., 2025b]<br>e.g., AI co-scientist [Gottweis et al., 2025a], ResearchAgent [Baek et al.,<br>Human-in-the-Loop 2024], MAPPS [Zhou et al., 2025a]<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
Domain-Specific Scientific Agents<br>e.g., SpatialAgent [Wang et al., 2025a], TAIS [Liu et al., 2024a], CRISPR-GPT [Qu et al., 2025], BioDis-<br>coveryAgent [Roohani et al., 2024], PerTurboAgent [Hao et al., 2025], BioAgents [Mehandru et al., 2025],<br>Genomics BIA [Xin et al., 2024], scBaseCount [Youngblut et al., 2025], CellAgent [Xiao et al., 2024], CompBioA-<br>gent [Zhang et al., 2025b], scAgent [Mao et al., 2025], CASSIA [Xie et al., 2024]<br>e.g., SAMPLE [Rapp et al., 2024], Virtual Lab [Swanson et al., 2024], ProtAgents [Ghafarollahi and Buehler,<br>Protein 2024a], Sparks [Ghafarollahi and Buehler, 2025], VibeGen [Ni and Buehler, 2025], AutoProteinEngine (Au-<br>toPE) [Liu et al., 2024b], ProChat [Huang et al., 2024b]<br>e.g., Biomni [Huang et al., 2025b], AI co-scientist [Gottweis et al., 2025b], TxAgent [Gao et al., 2025b],<br>BioResearcher [Luo et al., 2025b], STELLA [Jin et al., 2025a], CLADD [Lee et al., 2025], DrugAgent [Liu<br>Medicine et al., 2024c], PharmAgents [Gao et al., 2025d], LIDDiA [Averly et al., 2025], AgentMD [Jin et al., 2024a],<br>MedAgents [Tang et al., 2023], ClinicalGPT [Wang et al., 2023b], BehaveAgent [Aljovic et al., 2025]<br>e.g., Coscientist [Boiko et al., 2023], ChemCrow [M. Bran et al., 2024], ChemAgents [Song et al., 2025],<br>ChemReasoner [Sprueill et al., 2024], CACTUS [McNaughton et al., 2024], Chemist-X [Chen et al., 2023a], El<br>Chemistry Agente Q [Zou et al., 2025], LLM-RDF [Ruan et al., 2024], FROGENT [Pan et al., 2025], LARC [Baker et al.,<br>2025], FMG [Sun et al., 2025], MOOSE-Chem [Yang et al., 2024]<br>e.g., A-Lab [Szymanski et al., 2023], ChatMOF [Kang and Kim, 2024], ChatGPT Research Group [Zheng<br>et al., 2023], MDAgent [Shi et al., 2025], HoneyComb [Zhang et al., 2024b], LLMatDesign [Jia et al., 2024],<br>Materials MatAgent [Bazgir et al., 2025a], MatSciAgent [Chaudhari et al., 2025], MatPilot [Ni et al., 2024], Materials<br>Laws Multi-Agent Framework [Hu et al., 2024]<br>e.g., k-agents [Cao et al., 2024], AtomAgents [Ghafarollahi and Buehler, 2024c], Mephisto [Sun et al., 2024],<br>Physics QCopilot [Sha et al., 2025], OpenFOAMGPT [Pandey et al., 2025], MetaOpenFOAM [Chen et al., 2024b],<br>AI-Scientist Framework [Xu et al., 2025a]<br>e.g., Autonomous GIS Agent [Ning et al., 2025], GIS Copilot [Akinboyewa et al., 2025], LP-COMDA [Liu<br>Others et al., 2024d], ReAct agent for gas turbines [Song et al., 2024]<br>**----- End of picture text -----**<br>
...
|**Feature**|**Scientifc Agent**|**General LLM Agent**|
|---|---|---|
|Primary<br>Objective|To solve specifc, complex scientifc<br>problems and generate new knowledge.|To understand and respond to a wide<br>range of general user queries and<br>commands.|
|Knowledge<br>Base|Deeply integrated with specialized<br>scientifc databases, literature, and<br>models.|Relies on broad, general knowledge<br>acquired from vast, diverse training<br>data.|
|Reasoning|Employs rigorous, multi-step logical<br>deduction and inference based on<br>scientifc principles.|Utilizes common sense, associative,<br>and heuristic reasoning for broad tasks.|
...
|Evaluation<br>Metrics|Success is measured by the accuracy,<br>reproducibility, and novelty of the<br>scientifc results.|Success is measured by task<br>completion, user satisfaction, and<br>conversational quality.|
...
**----- Start of picture text -----**<br>
Human Intent<br>Natural Language<br>Computer Language<br>Physical<br>Information<br>y Entr<br>ilit op<br>ab y<br>rifi<br>Ve<br>**----- End of picture text -----**<br>
...
**==> picture [267 x 234] intentionally omitted <==**

**----- Start of picture text -----**<br>
ntOrchestra<br>t L<br>t<br>s<br>a<br>e<br>s<br>i<br>c C<br>ti n<br>g<br>o<br>g o<br>n<br>si<br>ulated<br>rm<br>Fo<br>ental<br>m<br>Experi<br>ature<br>er<br>Lit<br>esePsla, ns<br>h<br>pothc<br>Hyear<br>es<br>R<br>Data,<br>w<br>Ra<br>lts<br>esu<br>R<br>s<br>w<br>La<br>e,<br>dg<br>owle<br>Kn<br>ntific<br>Scie<br>T<br>ool Interfa<br>ce &<br>FindingsSummaries,<br>Goal,<br>Fee<br>dba<br>ck<br>F Program<br>u<br>nctio<br>nalitie<br>s<br>Guid<br>ance,<br>E<br>xecut<br>abl<br>e<br>e u<br>y d<br>a<br>A n<br>h e<br>i<br>c g<br>P<br>S e<br>**----- End of picture text -----**<br>


**==> picture [32 x 62] intentionally omitted <==**
...
|**Scientifc Phase**|**Human Intent**|**Natural Language**|**Computer Language**|**Physical Information**|**Overall Dissipation**|
|---|---|---|---|---|---|
|**Hypothesis Dis-**<br>**covery**|**Very High Entropy**<br>The intent is abstract<br>and completely open-<br>ended (e.g., "discover<br>a novel research gap").|**Very High Entropy**<br>Requires the highest<br>level of linguistic cre-<br>ativity to synthesize<br>disparate concepts and<br>articulate new ideas.|**Medium Entropy**<br>Primarily used for aux-<br>iliary tasks like knowl-<br>edge graph construc-<br>tion or data mining, not<br>the core creative act.|**High Entropy**<br>Historical data serves<br>as inspiration; the vol-<br>ume is vast, unstruc-<br>tured, and the valu-<br>able signals are non-<br>obvious.|**High**<br>Requires overcoming<br>high entropy in cre-<br>ative thought, making<br>it diffcult to automate.|
|**Experimental**<br>**Design**|**High Entropy**<br>The intent is creative<br>and requires navigating<br>a vast space of possi-<br>bilities (e.g., "design a<br>new experiment").|**Medium Entropy**<br>Involves<br>creating<br>a<br>novel,<br>precise,<br>and<br>unambiguous protocol<br>from an abstract idea.|**Medium Entropy**<br>Requires<br>selecting,<br>confguring,<br>and<br>integrating<br>from<br>a<br>vast library of existing<br>tools.|**Medium Entropy**<br>Must<br>predict<br>and<br>model<br>real-world<br>physical<br>laws<br>and<br>constraints, which are<br>inherently<br>complex<br>and uncertain.|**Medium**<br>Connects abstract hy-<br>potheses to the physi-<br>cal world, navigating<br>a vast and constrained<br>search space.|
|**Tool Use**|**Low Entropy**<br>The intent is highly<br>specifc and direct (e.g.,<br>"run this specifc analy-<br>sis tool").|**Low Entropy**<br>Typically consists of<br>structured commands<br>or simple instructions<br>with low ambiguity.|**Very Low Entropy**<br>Involves calling pre-<br>defned functions or<br>APIs; the syntax and<br>logic are deterministic.|**Low Entropy**<br>Input and output data<br>formats are generally<br>well-defned and struc-<br>tured, reducing uncer-<br>tainty.|**Very Low**<br>The process is deter-<br>ministic with low en-<br>tropy, making it the<br>easiest stage for AI to<br>automate reliably.|
|**Tool Creation**|**Very High Entropy**<br>Requires defning and<br>solving a problem for<br>which no solution cur-<br>rently exists.|**Very High Entropy**<br>Needs to describe the<br>principles, architecture,<br>and logic of a novel,<br>non-existent entity.|**Very High Entropy**<br>Involves designing and<br>implementing<br>new,<br>complex<br>algorithms<br>and<br>systems<br>from<br>scratch.|**Very High Entropy**<br>The new tool must re-<br>liably and robustly in-<br>teract with the complex<br>physical or computa-<br>tional world.|**Very High**<br>Combines the creative<br>diffculty of hypothesis<br>discovery with the en-<br>gineering challenge of<br>building a robust, func-<br>tional system.|
|**Results Analysis**<br>**& Refnement**|**Low Entropy**<br>The<br>intent<br>is<br>more<br>open than tool use (e.g.,<br>"fnd meaningful pat-<br>terns in the data").|**Low Entropy**<br>Requires<br>generating<br>interpretations,<br>sum-<br>maries, and insights,<br>allowing<br>for<br>more<br>linguistic fexibility.|**Low Entropy**<br>Involves writing analy-<br>sis scripts that are more<br>complex than simple<br>API calls but often rely<br>on standard libraries.|**Low Entropy**<br>Raw experimental data<br>often contains noise<br>and artifacts, introduc-<br>ing uncertainty into the<br>interpretation process.|**Low**<br>The task is constrained<br>by the provided data,<br>but requires sophisti-<br>cated reasoning to in-<br>terpret results and sug-<br>gest refnements.|
...
**----- Start of picture text -----**<br>
Information Analysis Across Autonomous Scientific Discovery Phases<br>Very High<br>Hypothesis  Very High Very High Medium High High<br>Discovery<br>High<br>Experimental Design High Medium Medium Medium Medium<br>Tool Use Low Low Very Low Low Very Low Medium<br>Tool Creation Very High Very High Very High Very High Very High<br>Low<br>Results Analysis & Refinement Low Low Low Low Low<br>Very Low<br>Human Intent Natural Language Computer Language Physical Information Overall Dissipation<br>Entropy / Dissipation Level<br>**----- End of picture text -----**<br>
...
**----- Start of picture text -----**<br>
Information Analysis Across Autonomous Scientific Discovery Phases<br>Overall Dissipation<br>Physical  Human<br>Information Intent<br>(Entropy) (Entropy)<br>Scientific Discovery Phases<br>Hypothesis Discovery<br>Experimental Design<br>Tool Use<br>Computer  Natural  Tool Creation<br>Language Language Results Analysis & Refinement<br>(Entropy) (Entropy)<br>Low<br>Medium<br>Very Low<br>High<br>Very High<br>**----- End of picture text -----**<br>
...
**==> picture [394 x 209] intentionally omitted <==**

**----- Start of picture text -----**<br>
Full AI<br>Hypothesis  Experimental  Tool Use Tool Creation Result Analysis  Autonomy<br>Discovery Design & Validation<br>AI-Led Hybrid<br>Tool Creation Result Analysis  Hypothesis  Experimental  Tool Use Model<br>& Validation  Discovery Design<br>Full Human-AI<br>Hypothesis  Experimental  Tool Use Tool Creation Result Analysis  Collaboration<br>Discovery Design & Validation<br>AI-Augmented<br>Tool Creation Hypothesis  Experimental  Tool Use Result Analysis  Model<br>Discovery Design & Validation<br>Human-Led<br>Hypothesis  Experimental  Tool Creation Tool Use Result Analysis  Model<br>Discovery Design & Validation<br>Human Human-AI AI<br>More Autonomy<br>**----- End of picture text -----**<br>
...
|**Tool-Augmented**<br>**Analysis**|Interaction with external<br>APIs, software, or hardware|Domain-specifc<br>data formats|ChemCrow [Bran et al.,<br>2023], Coscientist [Boiko<br>et al., 2023], Virtual Lab<br>[Boeck et al., 2023]|
...
**----- Start of picture text -----**<br>
Start  Automatic  External  Human-in-the-Loop<br>Refinement  Self-Correction Evaluation and  Approaches<br>Cycle Feedback<br>Feedback Feedback Feedback<br>Continuous Refinement Loop<br>Refine Agent<br>Increasing Validation Difficulty<br>**----- End of picture text -----**<br>
...
**==> picture [278 x 245] intentionally omitted <==**

**----- Start of picture text -----**<br>
New<br>Discoveries<br>Inferable<br>Knowledge<br>Humanity’s<br>Collective Knowledge<br>LLM (Explicit Facts, LLM<br>Procedural Models<br>and Verifiers)<br>Humanity’s<br>Knowledge<br>Closure<br>Agent<br>ntific<br>cie<br>S<br>LLM<br>LLM<br>**----- End of picture text -----**<br>
